...
try:
    ...
    def _on_collision(data):
        ...
        #Write a function for actor name
        actor_type = get_actor_name(data.other_actor)
        ...
        intensitry_of_collsion = math.sqrt(collision_event_record.x ** 2 + collision_event_record.y ** 2 + collision_event_record.z ** 2) 
        #print intensity
        print("collision intensity:", intensitry_of_collsion)
